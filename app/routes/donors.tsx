...
export default function DonsorsPage() {
  return (
    <div className="overflow-hidden" >
      ...
      <section className="bg-[#fff9f0] py-18 px-[45px] lg:px-[125px] w-screen">
        <div className="text-center text-lg">
          <h2 className="font-[Passion_One] text-3xl text-wolf-black">OUR DONORS</h2>
          <p className="text-black mb-5">Our donors make everything we do possible, from parts to competitions. <br /> <b>Please reach out</b> if you can give us a donation!</p>
          <span className="inline-flex flex-wrap justify-center gap-3 mb-12">
            ...
            <button onClick={openDonorPackageModal} className="px-3 py-3 md:px-4 text-xl rounded-md cursor-pointer hover:bg-white text-black outline-1 font-[Passion_One] inline-flex gap-2">View Package <Package className="scale-90" /></button>
          </span>
        </div>

        <div className="grid grid-cols-5 max-xl:grid-cols-4 [&>*]:justify-self-center [&>*]:self-center max-md:grid-cols-2 gap-[2rem_4%]">
          <img src="/donors/B-Tech_Manufacturing.jpg"></img>
          <img src="/donors/Brannon.jpg"></img>
          <img src="/donors/Ombrex_Telecom.png"></img>
          <img src="/donors/CMI_FG.png"></img>
          <img src="/donors/D4E.png"></img>
        </div>
      </section>
