  ...
  return <>
    ...
    <div className="px-[45px] lg:px-[145px] relative z-10 -mt-[calc(-7rem)] -mb-10">
      ...
      <div className="grid max-md:grid-cols-1 max-xl:grid-cols-2 grid-cols-3 gap-6">
        ...
        {[
          { name: "Email", cta: "Get in touch", icon: Mail, link: "mailto:3560frc@gmail.com", description: "Get in contact with us through email" },
          { name: "Sponsorship Package", cta: "Explore", icon: Package, link: "", onClick: openSponsorModal, description: "Take a look at our sponsorship packages" },
